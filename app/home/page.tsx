...
export default function Home() {
  ...
  const teamMembers = [
    { name: "Lhuts", role: "CEO / Founder", img: "/avatar1.png" },
    { name: "Jerik", role: "Product Lead / Product Manager", img: "/avatar2.png" },
    { name: "Dhan", role: "CTO / Tech Lead", img: "/avatar3.png" },
    { name: "Nadz", role: "Marketing & Growth Lead", img: "/avatar4.png" },
    { name: "Dyzon", role: "Sales & Customer Success", img: "/avatar5.png" },
    { name: "Nedz", role: "Operations & Finance Lead", img: "/avatar6.png" },
  ];
  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center text-gray-900 overflow-hidden bg-gradient-to-b from-[#FF8FB7] to-[#FFC1D4] scroll-smooth">
      {/* 🌈 Floating animated shapes that cover the whole page */}
      ...
      >
        ...
        <p className="max-w-3xl text-lg sm:text-xl text-gray-800 leading-relaxed z-10">
          We’re{" "}
          <span className="font-semibold text-purple-700">CODECRAFTERS</span> — a small but
          mighty creative studio based in{" "}
          <span className="font-semibold text-pink-600">Bongao, Tawi-Tawi</span>, built by a
          group of skilled makers who love turning ideas into real, working digital
          experiences. <br /> <br />
          From{" "}
          <span className="font-semibold text-purple-600">
            mobile apps, websites, and desktop software
          </span>{" "}
          to{" "}
          <span className="font-semibold text-rose-500">
            graphic design and social media content
          </span>
          , we help local businesses and creators show up online in a way that feels true to
          who they are. <br /> <br />
          Our team blends{" "}
          <span className="font-semibold text-yellow-500">code</span>,{" "}
          <span className="font-semibold text-cyan-500">design</span>, and{" "}
          <span className="font-semibold text-pink-500">storytelling</span> to build solutions
          that are easy to use, beautiful to look at, and ready to grow with your brand.
          Whether you’re just starting or leveling up, we craft every project with care,
          creativity, and heart. <br /> <br />
          <span className="italic text-gray-700">
            Let’s build something awesome together — for Bongao and beyond.
          </span>
        </p>
        ...
        <div className="mt-10">
          <button
            ...
            className="px-8 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg font-semibold shadow-md hover:scale-105 transition transform"
          >
      ...
      <AnimatePresence>
        {showTeam && (
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-10 max-w-6xl">
              {teamMembers.map((member, i) => (
                <motion.div
                  key={i}
                  whileHover={{ scale: 1.05 }}
                  className="bg-white/70 backdrop-blur-md rounded-2xl p-6 shadow-lg hover:shadow-2xl transition group border border-white/40"
                >
                  <div className="relative w-32 h-32 mx-auto mb-4">
                    <Image
                      ...
                      alt={member.name}
                      fill
                      className="rounded-full object-cover border-4 border-pink-200 shadow-md group-hover:border-purple-400 transition-all"
                    />
                  </div>
